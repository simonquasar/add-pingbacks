...
Tags: pingbacks, manual pingbacks, comments, linkbacks, custom post types, referrals
...
Manually add pingbacks to any post, page, or custom post type in WordPress with a simple interface.
